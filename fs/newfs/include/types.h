...
*******************************************************************************/
#define NFS_IO_SZ()                     (newfs_super.sz_io)       /* 512B*/
#define NFS_BLK_SZ()                    (newfs_super.sz_blk)      /* 1024B*/
#define NFS_DISK_SZ()                   (newfs_super.sz_disk)     /* 4MB */
...
#define NFS_ASSIGN_FNAME(pnewfs_dentry, _fname) memcpy(pnewfs_dentry->fname, _fname, strlen(_fname))
#define NFS_INO_OFS(ino)                (newfs_super.inode_offset + (ino) * NFS_BLK_SZ())
#define NFS_DATA_OFS(bno)               (newfs_super.data_offset + (bno) * NFS_BLK_SZ())
